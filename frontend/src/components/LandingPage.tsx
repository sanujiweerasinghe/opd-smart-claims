...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white">
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] font-semibold text-teal-600 uppercase tracking-wider">Smart Claims</p>
            </div>
          </div>
          
          <div className="flex items-center gap-4">
            <button className="hidden md:flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-teal-600 transition-colors bg-gray-50 px-3 py-1.5 rounded-full border border-gray-200">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-24 lg:min-h-[85vh] flex items-center bg-gradient-to-br from-teal-600 via-teal-500 to-emerald-500 overflow-hidden">
        {/* Decorative elements */}
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-lg md:text-2xl text-teal-50 max-w-2xl mx-auto mb-12 leading-relaxed font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
            ...
            <button 
              ...
              className="bg-white text-teal-600 hover:bg-gray-50 hover:scale-105 shadow-xl transition-all duration-300 font-bold rounded-full px-8 py-4 text-lg min-w-[200px]"
            >
              Submit New Claim
            </button>
...
const PortalCard = ({ icon, title, subtitle, description, buttonText, onClick, bgColor, borderColor, btnColor, featured }: PortalCardProps) => (
  <div className={`relative flex flex-col p-8 rounded-3xl transition-all duration-300 hover:-translate-y-2 bg-white ${featured ? 'shadow-2xl ring-2 ring-teal-200 scale-105 z-10' : 'shadow-lg border ' + borderColor}`}>
    {featured && (
      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-teal-600 text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider shadow-sm">
        Most Popular
      </div>
    )}
...
const StatItem = ({ value, label }: { value: string; label: string }) => (
  <div className="px-4 py-2">
    <p className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-emerald-500 mb-2">
      {value}
    </p>
